      ...
      <div class="container">
        ...
        <form action="/edit-snippet/{{$snippet->id}}" method="post">
            ...
            <div class="form-group mb-3 ">
              ...
              <input type="text" class="form-control mt-1" value="{{$snippet->title}}" id="exampleFormControlInput1" name="title" placeholder="Title">
            </div>
            <div class="form-group mb-3">
            ...
            <div class="form-group mb-3">
              ...
              <textarea name="body" class="form-control mt-1" id="exampleFormControlTextarea1" rows="3">{{$snippet->body}}</textarea>
            </div>
